...
def top_n_by_price(set_id, n=10, most_expensive=True, rarities=None):
    ...
    be scoped to desirable chase-card rarities (Illustration Rare, etc.)
    instead of literal bulk commons. Falls back to the full pool if the
    filter would leave nothing to show."""
...
if __name__ == "__main__":
    # Quick manual test: python fetch_prices_pokemon.py sv3pt5
    import sys
