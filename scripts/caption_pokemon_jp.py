"""
Template-based caption generator for Japanese Pokemon posts — mirrors
caption_pokemon.py exactly, except the "cheapest" hooks say Art Rare/AR
(the Japanese chase-card rarity name) instead of Illustration Rare/IR,
and the hashtag pool adds a couple of Japan-flavored tags.
"""
import random
...
HOOKS_CHEAP = [
    "The {n} most affordable Art Rares in {set_name} 🎨",
    "{set_name} full-arts that won't break the bank 👇",
    "{n} {set_name} Art Rares, ranked cheapest to less-cheap 🪙",
    "{set_name} Art Rares that still won't wreck your wallet 🎨",
    "Budget full-arts from {set_name} — TOP {n} 💵",
    "Chase the art, not the price — {set_name}'s cheapest ARs 🖼️",
]
...
CLOSERS = [
    ...
    "Save this before your next pack rip 📌",
    "Drop your set wishlist below 👇",
    "Which of these is on your want list? ✨",
]

HASHTAG_SETS = [
    "#pokemontcg #japanesepokemoncards #pokemoncollector #cardcollector",
    "#pokemontcg #pokemon151 #tcg #pokemonjapan #pokemoncollection",
    "#pokemontcg #japanesepokemoncards #pokemonmarket #wholesomecollecting",
    "#pokemon #pokemontcg #artrare #pokemonjapan #cardsofinstagram",
    "#pokemoncards #pokemonjapan #pokemonwishlist #cardpulls #pokemonfamily",
    "#pokemontcg #japanesetcg #pokemoncommunity #cardhunting #setcollecting",
]
