...
HOOKS_CHEAP = [
    "The {n} most affordable Illustration Rares in {set_name} 🎨",
    "{set_name} full-arts that won't break the bank 👇",
    "{n} {set_name} Illustration Rares, ranked cheapest to less-cheap 🪙",
    "{set_name} Illustration Rares that still won't wreck your wallet 🎨",
    "Budget full-arts from {set_name} — TOP {n} 💵",
    "Chase the art, not the price — {set_name}'s cheapest IRs 🖼️",
]
...
HASHTAG_SETS = [
    ...
    "#pokemon #pokemontcg #illustrationrare #tcgcollector #cardsofinstagram",
    "#pokemoncards #tcgcollector #pokemonwishlist #cardpulls #pokemonfamily",
    "#pokemontcg #tcgcollector #pokemoncommunity #cardhunting #setcollecting",
]
