...
def get_cards_for_set(set_code, max_pages=20, page_size=100):
    ...
    while page <= max_pages:
        ...
        # Early stop once we've collected everything the set actually has —
        # /search ranks exact-set matches first in practice, but this also
        # protects against wandering into unrelated sets on later pages.
